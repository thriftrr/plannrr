...
const STORAGE_KEY = 'ynabrr:palette'
...
//   3. the local choice (mock / no-login modes, or a session that hasn't
//      loaded yet) comes from localStorage and is mirrored there on change.
