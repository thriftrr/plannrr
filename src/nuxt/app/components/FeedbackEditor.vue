...
<template>
  <div class="fb-editor" :class="{ disabled }">
    <div class="fb-toolbar" role="toolbar" aria-label="Formatting">
      <button
        v-for="tool in tools"
        :key="tool.key"
        type="button"
    ...
    <div class="fb-surface" @click="editor?.commands.focus()">
      <div v-if="isEmpty" class="fb-placeholder" aria-hidden="true">{{ placeholder ?? 'What happened? What did you expect?' }}</div>
